"""Portable loader for the three repository YAML catalogs."""
...
def load_selection(catalog_dir: str | Path, *, agent_id: str, model_id: str,
    ...
    return CatalogSelection(AgentConfig(**agent), ModelConfig(**model),
